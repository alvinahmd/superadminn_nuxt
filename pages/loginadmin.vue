  ...
  <div>
    ...
    <section class="w-full h-full">
      <div class="w-full h-full flex flex-col items-center">
        <div class="bg-white shadow-lg h-80 top-44 z-1 mx-auto absolute" style="width: 580px">
          <div
            class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between"
          >
            <!-- Left column container with background-->
            <div class="mb-12 md:mb-0 md:w-8/12 lg:w-6/12 flex flex-col justify-center ">
              <img
                src="/fix.svg"
                class="pl-4 items-center"
                alt="image"
              >
              <h1 class="pl-4 font semi-bold text-gray-400">
                Enpowering & Delivering
              </h1>
              <p class="pl-4 font semi-bold text-gray-400">
                Businnes Transformation
              </p>
              <p class="pl-12 font semi-bold text-gray-400">
                With Technology
              </p>
            </div>
